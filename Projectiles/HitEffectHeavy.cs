...
{
    public class HitEffectHeavy : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (var j = 0; j < 16; j++)
            {
                ...
                sb.Draw(tex, Projectile.Center - Main.screenPosition + rand, sourceRectangle, Projectile.GetAlpha(col), Projectile.rotation, origin, Projectile.scale * (0.8f + 0.02f * j), SpriteEffects.None, 0);
            }
            return false;
        }
    }
