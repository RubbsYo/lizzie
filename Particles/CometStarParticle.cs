...
namespace LizSoundPack.Content.Effects
{
    ...
    public class CometStarParticle : DustParticle
    {
        private static Asset<Texture2D> tex = ModContent.Request<Texture2D>("LizSoundPack/Particles/Textures/CometStarEffect", AssetRequestMode.ImmediateLoad);
